...
EXTRA_ATTRIBUTE_KEYS_DAYPART = [
    ...
    "daypart_ice_qpf",
    "daypart_snow_range",
    "daypart_relative_humidity",
    "daypart_heat_index",
    "daypart_wind_chill",
    "daypart_thunder_category",
    "daypart_thunder_index",
    "daypart_uv_description",
    "daypart_uv_index",
    "daypart_wind_dir",
    "daypart_wind_dir_cardinal",
    "daypart_wind_speed",
    "daypart_wind_phrase",
    "daypart_wx_phrase_long",
